                ...
                <form class="form-inline" action="{{route('admin.contact.update',['id'=>$contact->id])}}" method="post" >
                    ...
                    <div class="form-group w-100 mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="text" name="name" id="name" class="form-control w-100 @error('name') is-invalid @enderror"
                                placeholder="Phone" value="{{(old('name')) ? old('name') : $contact->name}}">
                            @error('name')
                    ...
                    <div class="form-group w-100 mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="text" name="content" id="content" class="form-control w-100 @error('content') is-invalid @enderror"
                                placeholder="Phone" value="{{(old('content')) ? old('content') : $contact->content}}">
                            @error('content')
                            <small id="" class="text-danger mx-auto mt-1">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group w-100 mb-3 row">
                        ...
                        <div class="col-4">
                            ...
                            placeholder=" fa-phone"  value="{{(old('icon')) ? old('icon') : $contact->icon}}">
                            @error('icon')
                            <small id="" class="text-danger mx-auto mt-1">{{$message}}</small>
                            @enderror
                        </div>
