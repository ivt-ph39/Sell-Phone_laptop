                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.permission.update', $permission->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" value="{{ $permission->description }}" class="form-control">{{ $permission->description }}</textarea>
                                    </div>
                                    <hr>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.permission.update', $permission->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="keycode" value="{{ $permission->keycode }}" placeholder="Ex: role_list" class="form-control">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" class="form-control">
                                        ...
                                        @foreach ($permissionParents as $per)
                                            <option value="{{ $per->id }}" {{ ($permission->parent_id == $per->id) ? 'selected' : '' }}>
                                                {{ $per->name }}
                                            </option>
                                        @endforeach
                                    </select>
