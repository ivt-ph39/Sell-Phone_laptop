                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-inline">
                                        <a title="Chỉnh sửa vai trò" href="{{ route('admin.role.edit', $role->id) }}"
                                            class="btn btn-sm btn-outline-dark mr-2"><i class="fas fa-edit"></i></a>
                                        <form action="{{ route('admin.role.delete', $role->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button onclick="return confirm('Bạn có chắc muốn xóa vai trò này không???')"
                                                title="Xóa vai trò" class="btn btn-sm btn-outline-danger" type="submit"><i
