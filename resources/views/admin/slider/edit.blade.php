...
<div class="row pt-2 pl-3">
    <div class="col-12">
        ...
        <div class="card card-primary mt-5">
            ...
            <div class="card-body">
                <form class="form-inline" action="{{route('admin.slider.update',['id'=>$slider->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <input type="hidden" value="{{$slider->id}}" name="id">
                    <div class="form-group w-100 mb-3 row">
                        <div class="col-2">
                            <label for="name" class="d-flex justify-content-end pr-5">Tên <span class=" text-danger">(<sup>*</sup>)</span> :</label>
                        </div>
                        <div class="col-8">
                            <input type="text" name="name" id="name" class="form-control w-100 @error('name') is-invalid @enderror"
                                placeholder="" value="{{old('name') ? old('name') : $slider->name['base']}}">
                            @error('name')
                    ...
                    <div class="row w-100 mt-3 mb-5">
                        <div class="col-2"></div>
                        <div class="col-8">
                            <img src="{{($slider->path) ? $slider->path : uploads/images/sliders/download.png}}" width="600px" alt="" id="baner_review">
                        </div>
                    </div>
