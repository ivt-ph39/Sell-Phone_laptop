					...
					<ul class="main-nav nav navbar-nav">
						...
						<ul class="cate-nav main-nav nav navbar-nav">
							@foreach ($categories as $category)
								<li class="{{($category->hasChild($category->id) != false ) ? "hassub" : ""}}" ><a href="#">{{$category->name}}</a>
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									@foreach ($categories as $category)
										<li class="{{($category->name == 'Điện Thoại' ? "active" : "")}}"><a data-toggle="tab" href="">{{$category->name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div>
					...
					{{-- @foreach ($productNews as $key => $category)
						<!-- Products tab & slick -->
						<div class="col-md-12 {{($key !='phones')? "" : ""}} ">
							<div class="row">
